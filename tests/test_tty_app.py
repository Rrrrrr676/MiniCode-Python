...
def test_tty_sessions_command_lists_workspace_history(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "minicode.cli.handlers.list_sessions",
        lambda: [
            SessionMetadata(
...
def test_tty_rewind_command_rewinds_active_session(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("minicode.cli.handlers.rewind_session_data", fake_rewind)
...
def test_tty_session_rewind_command_rewinds_saved_session(tmp_path, monkeypatch) -> None:
    ...
    session.update_metadata()
    monkeypatch.setattr(
        "minicode.cli.handlers.get_latest_session",
    ...
    monkeypatch.setattr("minicode.cli.handlers.rewind_session", fake_rewind)
