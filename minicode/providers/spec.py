"""Pure provider identification primitives.

This module intentionally depends only on the standard library so configuration
validation can identify a provider without importing the model registry or any
network adapter.
"""
